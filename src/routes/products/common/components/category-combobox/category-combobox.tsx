          ...
          >
            {showTag && (
              <button
                ...
                className="txt-compact-small-plus absolute left-0.5 top-0.5 flex h-[28px] items-center rounded-[4px] border bg-ui-bg-base py-[3px] pl-1.5 pr-1 text-ui-fg-subtle outline-none transition-fg focus-within:border-ui-fg-interactive hover:bg-ui-bg-base-hover"
              >
